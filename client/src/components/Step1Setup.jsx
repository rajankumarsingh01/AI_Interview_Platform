...
//   FaChartLine,
// } from 'react-icons/fa'
// // ❗ IMPORTANT: setUserData import missing tha
...
//       // ❗ FIX: typo creditsLef → creditsLeft
//       if (userData) {
...
//       className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-100 px-4'
//     >
...
//           className='relative bg-gradient-to-br from-green-500 to-green-100 p-12 flex flex-col justify-center'
//         >
//           <h2 className='text-3xl font-bold text-gray-700 mb-6'>Start your AI Resume</h2>
...
//                 className='border-2 border-dashed border-gray-300 rounded-xl text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition min-h-[120px] flex items-center justify-center'
//               >
...
//                       whileHover={{ scale: 1.02 }}
//                       className='mt-4 bg-gray-900 text-white px-5 py-3 rounded-lg hover:bg-gray-800'
//                     >
...
//               whileHover={{ scale: 1.03 }}
//               whileTap={{ scale: 0.95 }}
//               className='w-full disabled:bg-gray-400 bg-green-600 hover:bg-green-700 text-white py-3 rounded-full text-lg font-semibold shadow-md'
//             >
