...
//     if (!role || !experience || !mode || !resumeText) {
//       return res.status(400).json({ error: "role, experience, mode and resumeText are required." })
//     }
  ...
  try {
    ...
    if (!role || !experience || !mode || !resumeText) {
      return res.status(400).json({
        error: "role, experience, mode and resumeText are required."
      });
    }
...
export const finishinterview = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      ...
      averageCommunication: Number(avgCommunication.toFixed(1)),
      averageCorrectness: Number(avgCorrectness.toFixed(1)),
...
export const getInterviewReport = async (req, res) => {
  try {
    ...
    return res.json({
      finalScore: Number(finalScore.toFixed(1)), // ✅ FIXED
...
export const deleteInterview = async (req, res) => {
    try {
        ...
        // user ka hi interview delete ho (security)
